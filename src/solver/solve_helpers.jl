...
SymbolicUtils.promote_type(::typeof(ssqrt), ::Type{T}) where {T} = T
...
SymbolicUtils.promote_type(::typeof(scbrt), ::Type{T}) where {T} = T
...
SymbolicUtils.promote_type(::typeof(slog), ::Type{T}) where {T} = T
